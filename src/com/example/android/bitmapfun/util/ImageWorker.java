 ...
 * 
 * ������װ�������һЩ���ⳤʱ�����еĹ��� => ������һ��λͼ��һ��ImageView��
 * �����Դ��������:ʹ�õ��ڴ�ʹ��̻��棬�����ں�̨�̣߳�������һ��ռλ��ͼ��
 */
public abstract class ImageWorker {
     ...
     * ���{@link ImageCache}��ʹ�� {@link ImageWorker#setImageCache(ImageCache)}�������ˣ��ڴ�ʹ��̻��潫��ʹ�á�
     * ���ͼ�����ڴ滺���з��֣���������
     * ���� {@link AsyncTask} ���ᴴ��ȥ�첽����bitmap
     * 
    ...
    /**
     * 
     * �������Ϊ��ӭ�������Լ������һ��ͼƬurl���鹹�ɵ�adapter��д��Ҳ��һ������{@link ImageWorker#loadImage(Object data, ImageView imageView)} �������������ͼƬ
